# Supported sites
 ...
 - **Gaskrank**
 - **Gazeta**
 - **GBNews**: GB News clips, features and live stream
 - **GDCVault**
 - **GediDigital**
 ...
 - **orf:iptv**: iptv.ORF.at (Currently broken)
 - **orf:on**
 - **orf:podcast**
 - **orf:sound**
 - **ORFONLive**
 ...
 - **XBef**
 - **XboxClips**
 - **XFileShare**: XFileShare-based sites: Aparat, FileMoon, GoUnlimited, GoVid, HighStream, HolaVid, Uqload, V?dB?m, vidlo, VidLocker, VidShare, WolfStream, XVideoSharing
 - **XHamster**
 - **XHamsterEmbed**
 - **XHamsterUser**
 - **xiami:album**: 虾米音乐 - 专辑
